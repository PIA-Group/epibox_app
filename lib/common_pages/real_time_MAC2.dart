          ...
          child: ListView(
            children: <Widget>[
              ...
              if (widget.channelsMAC2Notifier.value.length > 0)
                PlotDataTitle(channels: widget.channelsMAC2Notifier.value[0], sensor: widget.sensorsMAC2Notifier.value[0]),
              if (widget.channelsMAC2Notifier.value.length > 0)
                ValueListenableBuilder(
              ...
              if (widget.channelsMAC2Notifier.value.length > 1)
                PlotDataTitle(channels: widget.channelsMAC2Notifier.value[1], sensor: widget.sensorsMAC2Notifier.value[1]),
              if (widget.channelsMAC2Notifier.value.length > 1)
                ValueListenableBuilder(
              ...
              if (widget.channelsMAC2Notifier.value.length > 2)
                PlotDataTitle(channels: widget.channelsMAC2Notifier.value[2], sensor: widget.sensorsMAC2Notifier.value[2]),
              if (widget.channelsMAC2Notifier.value.length > 2)
                ValueListenableBuilder(
              ...
              if (widget.channelsMAC2Notifier.value.length > 3)
                PlotDataTitle(channels: widget.channelsMAC2Notifier.value[3], sensor: widget.sensorsMAC2Notifier.value[3]),
              if (widget.channelsMAC2Notifier.value.length > 3)
                ValueListenableBuilder(
              ...
              if (widget.channelsMAC2Notifier.value.length > 4)
                PlotDataTitle(channels: widget.channelsMAC2Notifier.value[4], sensor: widget.sensorsMAC2Notifier.value[4]),
              if (widget.channelsMAC2Notifier.value.length > 4)
                ValueListenableBuilder(
              ...
              if (widget.channelsMAC2Notifier.value.length > 5)
                PlotDataTitle(channels: widget.channelsMAC2Notifier.value[5], sensor: widget.sensorsMAC2Notifier.value[5]),
              if (widget.channelsMAC2Notifier.value.length > 5)
                ValueListenableBuilder(
