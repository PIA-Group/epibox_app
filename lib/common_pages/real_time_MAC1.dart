...
class RealtimePageMAC1 extends StatefulWidget {
  ...
  @override
  _RealtimePageMAC1State createState() => _RealtimePageMAC1State();
}

class _RealtimePageMAC1State extends State<RealtimePageMAC1> {
  ...
  Future<void> _timedOutDialog(device) async {
    ...
    if (!_isTimedOutOpen) {
      ...
      widget.dataMAC1Notifier.addListener(f);
    }
    /* if (_isTimedOutOpen) {
      Navigator.of(context, rootNavigator: true).pop();
    } */
  ...
  void initState() {
    ...
    widget.dataMAC1Notifier.addListener(() {
      if (this.mounted) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: new PreferredSize(
        ...
        child: AppBar(
          title: Text('Dispositivo MAC 1', style: TextStyle(fontWeight: FontWeight.bold),),
